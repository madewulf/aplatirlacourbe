! function(t) {
    ...
    function d(t, n) {
        let e, i = 0,
            ...
            o = 0;
        if (void 0 === n)
            for (let n of t) null != n && (n = +n) >= n && (e = n - r, r += e / ++i, o += e * (n - r));
        else {
            let a = -1;
    ...
    var g = function(t, n) {
            let e, i;
            if (void 0 === n)
                for (const n of t) null != n && (void 0 === e ? n >= n && (e = i = n) : (e > n && (e = n), i < n && (i = n)));
            else {
                let r = -1;
    ...
    function L(t, n) {
        let e, i = -1,
            r = -1;
        if (void 0 === n)
            for (const n of t) ++r, null != n && (e < n || void 0 === e && n >= n) && (e = n, i = r);
        else
            for (let o of t) null != (o = n(o, ++r, t)) && (e < o || void 0 === e && o >= o) && (e = o, i = r);
        return i
    }
    ...
    function R(t, n) {
        let e = 0,
            i = 0;
        if (void 0 === n)
            for (let n of t) null != n && (n = +n) >= n && (++e, i += n);
        else {
            let r = -1;
    ...
    function B(t, n = r.a) {
        ...
        if (1 === n.length) {
            ...
            for (const r of t)(i ? n(r, e) < 0 : 0 === n(r, r)) && (e = r, i = !0);
        return e
    }
    ...
    var X = function(t) {
        ...
        for (var n = -1, e = Object(H.a)(t, Q), i = new Array(e); ++n < e;)
            for (var r, o = -1, a = i[n] = new Array(r); ++o < r;) a[o] = t[o][n];
        return i
    };
    ...
    function s(t, n, e) {
        if (a = (t = Float64Array.from(function*(t, n) {
            ...
            var a, s = (a - 1) * n,
                u = Math.floor(s),
                c = Object(i.a)(Object(o.a)(t, u).subarray(0, u + 1));
    ...
    function f() {
        ...
        var t = this.replayButton.node().getBoundingClientRect(),
            n = t.width,
            e = t.height;
    ...
    function _() {
        ...
        var n = this.data.filter((function(t) {
            ...
            r = n === this.lastSick && e === this.lastRecovered;
        ...
        for (var h = 0; h < this.data.length; h++) {
            ...
            for (var p = 0; p < this.data.length; p++) {
                ...
                if (g.collided = !1, h !== p && a.lineLength([d.pos, g.pos]) < d.radius + g.radius && !d.collided && !g.collided) {
                    var m = a.pointTranslate(d.pos, d.angle, d.speed),
                        v = a.pointTranslate(g.pos, g.angle, g.speed),
                        y = a.lineLength([m, v]),
                        _ = a.pointTranslate(d.pos, g.angle, g.speed),
            ...
            for (var x = 0; x < this.walls.length; x++) {
                var T = this.walls[x],
                    M = a.pointTranslate(d.pos, a.lineAngle([d.pos, s(d.pos, T)]), d.radius);
            ...
            if (d.pos[0] <= d.radius || d.pos[0] >= this.width - d.radius) {
                var k = a.pointTranslate(d.pos, d.angle, d.speed),
                    C = a.lineLength([this.center, k]),
                    S = a.angleReflect(d.angle, 90),
                    E = a.pointTranslate(d.pos, S, d.speed);
                a.lineLength([this.center, E]) < C && (d.angle = S)
            }
            if (d.pos[1] <= d.radius || d.pos[1] >= this.height - d.radius) {
                var A = a.pointTranslate(d.pos, d.angle, d.speed),
                    O = a.lineLength([this.center, A]),
                    N = a.angleReflect(d.angle, 0),
                    I = a.pointTranslate(d.pos, N, d.speed);
        ...
        return function(r, o, a) {
            ...
            if (u)
                for (var l = 0, h = u.length; l < h; ++l)
                    if ((s = u[l]).type === t.type && s.name === t.name) return this.removeEventListener(s.type, s.listener, s.capture), this.addEventListener(s.type, s.listener = c, s.capture = e), void(s.value = n);
    ...
    ht.prototype = ft.prototype = {
        ...
        select: function(t) {
            ...
            for (var n = this._groups, e = n.length, i = new Array(e), r = 0; r < e; ++r)
                for (var o, a, s = n[r], u = s.length, c = i[r] = new Array(u), h = 0; h < u; ++h)(o = s[h]) && (a = t.call(o, o.__data__, h, s)) && ("__data__" in o && (a.__data__ = o.__data__), c[h] = a);
            return new ht(i, this._parents)
        },
        selectAll: function(t) {
            "function" != typeof t && (t = f(t));
            for (var n = this._groups, e = n.length, i = [], r = [], o = 0; o < e; ++o)
                for (var a, s = n[o], u = s.length, c = 0; c < u; ++c)(a = s[c]) && (i.push(t.call(a, a.__data__, c, s)), r.push(a));
            return new ht(i, r)
        },
        filter: function(t) {
            "function" != typeof t && (t = d(t));
            for (var n = this._groups, e = n.length, i = new Array(e), r = 0; r < e; ++r)
                for (var o, a = n[r], s = a.length, u = i[r] = [], c = 0; c < s; ++c)(o = a[c]) && t.call(o, o.__data__, c, a) && u.push(o);
            return new ht(i, this._parents)
        },
        data: function(t, n) {
        ...
        merge: function(t) {
            for (var n = this._groups, e = t._groups, i = n.length, r = e.length, o = Math.min(i, r), a = new Array(i), s = 0; s < o; ++s)
                for (var u, c = n[s], l = e[s], h = c.length, f = a[s] = new Array(h), d = 0; d < h; ++d)(u = c[d] || l[d]) && (f[d] = u);
            for (; s < i; ++s) a[s] = n[s];
            return new ht(a, this._parents)
        },
        order: function() {
            for (var t = this._groups, n = -1, e = t.length; ++n < e;)
                for (var i, r = t[n], o = r.length - 1, a = r[o]; --o >= 0;)(i = r[o]) && (a && 4 ^ i.compareDocumentPosition(a) && a.parentNode.insertBefore(i, a), a = i);
            return this
        },
        sort: function(t) {
            function n(n, e) {
        ...
        classed: function(t, n) {
            var e = L(t + "");
            if (arguments.length < 2) {
                for (var i = R(this.node()), r = -1, o = e.length; ++r < o;)
        ...
        insert: function(t, n) {
            var e = "function" == typeof t ? t : u(t),
                i = null == n ? J : "function" == typeof n ? n : l(n);
            return this.select((function() {
    ...
    var _t = function() {
        ...
        Tt = function(t, n, e) {
            ...
            for (var i, r = 0, o = n ? n.length : 0; r < o; ++r)
                if ((i = n[r]).identifier === e) return wt(t, i);
            return null
        },
        Mt = function(t, n) {
            null == n && (n = _t().touches);
    ...
    var i = Math.random,
        ...
        v = function t(n) {
            function e(t, e, i) {
                var r;
                return 0 == (t = +t) ? r = t => -Math.log(t) : (t = 1 / t, r = n => Math.pow(n, t)), e = null == e ? 0 : +e, i = null == i ? 1 : +i,
                    function() {
    ...
    n.a = function(t, n, e) {
        ...
        if (s > 0)
            for (t = Math.ceil(t / s), n = Math.floor(n / s), o = new Array(r = Math.ceil(n - t + 1)); ++u < r;) o[u] = (t + u) * s;
        else
            for (t = Math.floor(t * s), n = Math.ceil(n * s), o = new Array(r = Math.ceil(t - n + 1)); ++u < r;) o[u] = (t - u) / s;
    ...
    var m = "\\s*([+-]?\\d+)\\s*",
        ...
        b = new RegExp("^rgb\\(" + [y, y, y] + "\\)$"),
        x = new RegExp("^rgba\\(" + [m, m, m, v] + "\\)$"),
        T = new RegExp("^rgba\\(" + [y, y, y, v] + "\\)$"),
        M = new RegExp("^hsl\\(" + [v, y, y] + "\\)$"),
        k = new RegExp("^hsla\\(" + [v, y, y, v] + "\\)$"),
        C = {
            aliceblue: 15792383,
    ...
    var G = function t(n) {
        ...
        function i(t, n) {
            var i = e((t = L(t)).r, (n = L(n)).r),
                r = e(t.g, n.g),
                o = e(t.b, n.b),
                a = z(t.opacity, n.opacity);
            return function(n) {
    ...
    function Y(t) {
        return function(n) {
            ...
            return o = t(o), a = t(a), s = t(s), i.opacity = 1,
                function(t) {
    ...
    var J = function(t, n) {
        n || (n = []);
        var e, i = t ? Math.min(n.length, t.length) : 0,
            r = n.slice();
        return function(o) {
    ...
    var Z = function(t, n) {
        ...
        nt = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
        et = new RegExp(nt.source, "g");
    var it = function(t, n) {
            var e, i, r, o = nt.lastIndex = et.lastIndex = 0,
                a = -1,
                s = [],
                u = [];
            for (t += "", n += "";
                (e = nt.exec(t)) && (i = et.exec(n));)(r = i.index) > o && (r = n.slice(o, r), s[a] ? s[a] += r : s[++a] = r), (e = e[0]) === (i = i[0]) ? s[a] ? s[a] += i : s[++a] = i : (s[++a] = null, u.push({
                i: a,
                x: K(e, i)
            })), o = et.lastIndex;
    ...
    function lt(t, n, e) {
        var i = t[0],
            ...
            o = n[0],
            a = n[1];
        return r < i ? (i = ct(r, i), o = e(a, o)) : (i = ct(i, r), o = e(o, a)),
            function(t) {
                return o(i(t))
            }
    }
    ...
    var sn = an(0),
        ...
        bn = wn,
        xn = (wn.range, tn((function() {}), (function(t, n) {
            t.setTime(+t + n)
        }), (function(t, n) {
            return n - t
        })));
    ...
    Vn = function(t) {
        ...
        shortMonths: ["Jan", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Aug", "Sep", "Oct", "Nov", "Dec"]
    ...
    function ni(t, n, e, i, r, o, a, s, u) {
        ...
        function T(n, e, i) {
            if (null == n && (n = 10), "number" == typeof n) {
                var r, o = Math.abs(i - e) / n,
                    a = Object(Qt.a)((function(t) {
                        return t[2]
                    })).right(b, o);
    ...
    var i = Object.assign({}, e(1), e(13), e(8), e(18)),
        r = function(t) {
            return t[0].toUpperCase() + t.slice(t.length - (t.length - 1))
        },
        o = e(4).TOTAL_TICKS;
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
                ...
                if (Math.abs(h * u - c * l) > 1e-6 && o) {
                    var d = e - a,
                        ...
                        v = Math.sqrt(g),
                        y = Math.sqrt(f),
                        _ = o * Math.tan((i - Math.acos((g + f - m) / (2 * v * y))) / 2),
                        w = _ / y,
                        b = _ / v;
    ...
    var A = function() {
        ...
        function d() {
            var c, d, x = +t.apply(this, arguments),
                T = +n.apply(this, arguments),
                M = r.apply(this, arguments) - y,
                k = o.apply(this, arguments) - y,
                C = l(k - M),
                A = k > M;
            if (s || (s = c = u()), T < x && (d = T, T = x, x = d), T > 1e-12)
                if (C > _ - 1e-12) s.moveTo(T * f(M), T * g(M)), s.arc(0, 0, T, M, k, !A), x > 1e-12 && (s.moveTo(x * f(k), x * g(k)), s.arc(0, 0, x, k, M, A));
                else {
                    var O, N, I = M,
                        L = k,
                        R = M,
                        ...
                        U = p(l(T - x) / 2, +e.apply(this, arguments)),
                        W = U,
                        F = U;
                    if (V > 1e-12) {
                        var B = b(V / x * g(j)),
    ...
    var R = function() {
        ...
        P = function() {
            ...
            function l(c) {
                var l, h, f, d, p, g = c.length,
                    m = !1,
                    v = new Array(g),
                    y = new Array(g);
                for (null == o && (s = a(p = u())), l = 0; l <= g; ++l) {
                    if (!(l < g && r(d = c[l], l, c)) === m)
                        if (m = !m) h = l, s.areaStart(), s.lineStart();
                        else {
    ...
    Et.prototype = {
        ...
        lineEnd: function() {
            var t = this._x,
                ...
                e = t.length - 1;
            if (e > 0)
                for (var i, r = t[0], o = n[0], a = t[e] - r, s = n[e] - o, u = -1; ++u <= e;) i = u / e, this._basis.point(this._beta * t[u] + (1 - this._beta) * (r + i * a), this._beta * n[u] + (1 - this._beta) * (o + i * s));
        ...
        lineEnd: function() {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var i = en(t), r = en(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(i[0][o], r[0][o], i[1][o], r[1][o], t[a], n[a]);
    ...
    var cn = function(t, n) {
            if ((r = t.length) > 1)
                for (var e, i, r, o = 1, a = t[n[0]], s = a.length; o < r; ++o)
                    for (i = a, a = t[n[o]], e = 0; e < s; ++e) a[e][1] += a[e][0] = isNaN(i[e][1]) ? i[e][0] : i[e][1]
        },
        ln = function(t) {
    ...
    var fn = function() {
        ...
        pn = function(t, n) {
            if ((s = t.length) > 0)
                for (var e, i, r, o, a, s, u = 0, c = t[n[0]].length; u < c; ++u)
                    for (o = a = 0, e = 0; e < s; ++e)(r = (i = t[n[e]][u])[1] - i[0]) > 0 ? (i[0] = o, i[1] = o += r) : r < 0 ? (i[1] = a, i[0] = a += r) : (i[0] = 0, i[1] = r)
        },
        gn = function(t, n) {
            if ((e = t.length) > 0) {
    ...
    var i, r = e(2),
        ...
        u = {
            ...
            s: function(t, n) {
                ...
                var r = e[0],
                    o = e[1],
                    s = o - (i = 3 * Math.max(-8, Math.min(8, Math.floor(o / 3)))) + 1,
                    u = r.length;
    ...
    n.a = function(t) {
        var n, e, a = void 0 === t.grouping || void 0 === t.thousands ? c : (n = l.call(t.grouping, Number), e = t.thousands + "", function(t, i) {
            ...
            p = void 0 === t.numerals ? c : function(t) {
                return function(n) {
            ...
            function S(t) {
                ...
                if ("c" === x) f = k(t) + f, t = "";
                    ...
                    if (t = isNaN(t) ? v : k(Math.abs(t), w), b && (t = function(t) {
                        ...
                        }(t)), g && 0 == +t && (g = !1), c = (g ? "(" === r ? r : m : "-" === r || "(" === r ? "" : r) + c, f = ("s" === x ? h[8 + i / 3] : "") + f + (g && "(" === r ? ")" : ""), C)
                ...
                _ && !l && (t = a(t, 1 / 0));
                var S = c.length + t.length + f.length,
                    E = S < y ? new Array(y - S + 1).join(n) : "";
    ...
    function x(t, n) {
        if (function(t, n) {
                ...
                for (let o = 0; o < 2; o++)
                    for (let a = 0; a < 2; a++)
                        if (i = t[o], r = n[a], i[0] === r[0] && i[1] === r[1]) {
                            e = !0;
                            break
                        } var i, r;
                return e
    ...
    if (g.init(r), g.tick(), r) {
        ...
        ! function t() {
            requestAnimationFrame(t), m(l), m(h), m(f), m(d), m(p), m(g), y.isNotOffScreen() && !y.calculationHasStarted && (y.setData([{
                ...
                name: "Attempted quarantine",
                data: v(d, !0)
            }, {
                name: "Moderate distancing",
                data: v(p, !1)
            }, {
                name: "Extensive distancing",
                data: v(g, !1)
    ...
    (function() {
        ...
        window.TWP = window.TWP || {
            Module: {}
        }, window.TWP.Module = window.TWP.Module || {}, window.TWP.Module.util = t, t.getParameters && void 0 !== t.getParameters || (t.getParameters = function(t) {
            var n, e, i = [],
                r = {};
    ...
    ! function(t, n) {
        var e = n.wp_pb = n.wp_pb || {},
            i = e.nav = e.nav || {};
        var r = {
            isHomepage: t("#logo-in-nav").hasClass("homePage"),
            init: function() {
                    ...
                    (n.ActiveXObject || "ActiveXObject" in n) && (t("#main-sections-nav").addClass("ie"), t("#wp-header").addClass("ie")), t("#sections-menu-off-canvas ul.side-nav li").each((function() {
                        if (!t(this).hasClass("nav-screenreader-link")) {
                            var n = t(this).find(">a"),
                                ...
                                i = n.attr("href");
                            if (t(this).hasClass("main-nav")) n.attr("href", i + "?nid=menu_nav_" + e);
                        ...
                        if (n.stopPropagation(), n.preventDefault(), !t("html").hasClass("drawbridge-up")) {
                            var e = t(this),
                                i = t("#main-sections-nav");
                            if (i.hasClass("active")) t("body").removeClass("left-menu left-menu-pb"), e.removeClass("active"), i.removeClass("active");
                            else {
                                if (t("body").hasClass("account-menu") && (t("body").removeClass("account-menu"), t("#user-menu").removeClass("nav-user-show"), t(".sign-up-buttons").removeClass("nav-user-show")), t("body").addClass("left-menu left-menu-pb"), !t.trim(t("#sections-menu-off-canvas").html()).length) {
                                    var o = "",
                                        s = !r.isHomepage && wp_pb.canonical_url ? "&contentUri=" + wp_pb.canonical_url : "";
            ...
            setScrollEvents: function() {
                var e = t("#logo-in-nav").hasClass("homePage"),
                    r = t(this).scrollTop() || 0,
                    s = o(),
                    u = t(".pb-f-page-notification-bar"),
                    c = 0;
                    ...
                    a = {
                        ...
                        getUserMenu: function() {
                            return [{
                                ...
                                title: "Sign out",
                                href: TWP.signin.logouturl_page + "?tid=nav_acctmgnt_menu"
                            }]
                        },
            ...
            t("#sections-menu-off-canvas > ul > li").each((function() {
                if (t("#main-sections-nav").hasClass("active") && t(this).hasClass("has-sub")) {
                    var e = t(this).find("ul").height() / 2 - 10,
                        i = t(this).offset().top - t(n).scrollTop();
            ...
            var t = {
                    ...
                    originalInit: function(t) {
                        ...
                        r.hasClass("sticky-top-sharebar") && i.init(), r.each((function(t, i) {
                            ...
                            var r = $(i),
                                o = $(".tool:not(.more, .read-later-bookmark, .read-later-list)", r),
                                a = $(".social-tools-wrapper", r),
                                s = $(".tool.more", a),
                                u = $(".social-tools-additional", r),
                                c = window.innerWidth > 0 ? window.innerWidth : screen.width;
                            mobile_browser;
                            if (s.off("click").on("click", this, (function(t) {
                                    s.hide(), u.show("fast", (function(t) {
                                        r.addClass("expanded"), $(".social-tools", u).animate({
                                            "margin-left": 0
                                        }, 4250)
                                    })).addClass("more-open")
                                })), o.on({
                ...
                n = {
                    ...
                    enableCollisionDetection: (a = "getBoundingClientRect" in document.documentElement, u = 0, function(t) {
                        ...
                        !a || u > 3 || (n = setInterval((function() {
                            var e, i, r, o, a = t.closest(".pb-f-sharebars-top-share-bar"),
                                s = a.find(".top-sharebar-wrapper"),
                                u = $("html").hasClass("gallery_story") ? $(".pb-f-gallery-gallery") : $("#main-content"),
                                c = a.data("__mccollides"),
                                l = {
                                    value: void 0
                                };
                            a.length && s.length && u.length ? (l.value = (e = u[0], i = s[0], r = e.getBoundingClientRect(), o = i.getBoundingClientRect(), !(r.top > o.bottom || r.right < o.left || r.bottom < o.top || r.left > o.right)), c && l.value === c.value || (wp_pb.report("sticky-vertical-sharebar", "collides_with_main_content", l.value), a.data("__mccollides", {
                                value: l.value
                            }))) : clearInterval(n)
                        }), 600), u++)
                    })
    ...
    ! function(o, s) {
        ...
        u.prototype = {
            _reveal: function(t) {
                ...
                "IMG" !== t.tagName && "IFRAME" !== t.tagName || (t.addEventListener("load", r), t.addEventListener("error", i), t.classList.add(n.class_loading)),
                    function(t, n, e) {
                        var i = t.tagName,
                            r = t.dataset[e];
                        if ("IMG" === i) {
    ...
    r = [], void 0 === (o = "function" == typeof(i = function() {
        ...
        function l(t, i, r) {
            if (0 === r) t.style.whiteSpace = i, e = 0, n = [],
                function t(i, r) {
                    if (i.nodeType === i.ELEMENT_NODE)
                        if ("nowrap" === window.getComputedStyle(i).whiteSpace) {
                            ...
                            t(n, !0)
                        })), r && (e += i.outerHTML.length - i.innerHTML.length);
                    else i.nodeType === i.COMMENT_NODE ? e += i.length + 7 : i.nodeType === i.PROCESSING_INSTRUCTION_NODE ? e += i.length + 2 : e += i.length
        ...
        function f(n, e) {
            var i, r = /([^\S\u00a0]|-|\u2014|\u2013|\u00ad)(?![^<]*>)/g;
            if (!t)
                for (t = [], i = r.exec(n); null !== i;) c(i.index) || t.push(i.index), i = r.exec(n);
        ...
        a.prototype.load = function(t, n) {
            ...
            return new Promise((function(t, n) {
                if (h() && ! function() {
                    ...
                    x.dir = "ltr", i(h, d(r, "sans-serif")), i(p, d(r, "serif")), i(g, d(r, "monospace")), x.appendChild(h.a), x.appendChild(p.a), x.appendChild(g.a), document.body.appendChild(x), _ = h.a.offsetWidth, w = p.a.offsetWidth, b = g.a.offsetWidth,
                        function t() {
                            if ((new Date).getTime() - f >= l) x.parentNode && x.parentNode.removeChild(x), n(Error(l + "ms timeout exceeded"));
                            else {
    ...
    function a(t) {
        this.debug = t || function() {}, this.events = {}, this._fireEvent = function(t, n) {
            var e = "app",
                i = t,
                r = t.indexOf("."); - 1 != r && (e = t.substring(0, r), i = t.substring(r + 1)), this.debug("Fired ".concat(e, ".").concat(i, ":").concat(n));
            var o = this.events[e];
            if (o) {
                o._called = !0;
        ...
        i.Coral.events = {
            "mutation.CreateLikeAction.success": {
                eVar26: "comments_like",
                event: "event80"
            },
            "mutation.PostFlag.success": {
                eVar26: "comments_report",
                event: "event80"
            },
            "plugin.talk-plugin-wapo-permalink.copySuccess": {
                eVar26: "comments_link",
                event: "event80"
            },
            "mutation.IgnoreUser.success": {
                eVar26: "comments_ignore",
                event: "event80"
            },
            DNE1: {
                eVar26: "comments_respect",
                event: "event80"
            },
            "query.CoralEmbedStream_Embed.ready": {
        ...
        var o = function() {
                    ...
                    ! function() {
                        ...
                        for (var n in i.Coral.events) i.Coral.events.hasOwnProperty(n) && n.indexOf("DNE") < 0 && document.addEventListener(n, (function(n) {
                            if ("function" == typeof window.sendDataToOmniture) try {
                                ...
                                window.sendDataToOmniture("coral.".concat(r), i.Coral.events[r].event, Object.assign({}, t, {
                                    eVar26: o
                                })), e && window.console && console.log && console.log("OMNITURE: ".concat(i.Coral.events[r].event, " ").concat(o))
                            } catch (t) {}
                        }), !1)
                    }()
                } catch (t) {}
            ...
            a = {
                ...
                init: function() {
                    ...
                    r.register("comments_coral", "auth_response", a.showAuthStatusMessage), s.length && u.length ? a.checkAuthStatus() : (s.length && !u.length ? r.report("comments_coral", "auth_response", {
                        status: "incomplete"
                    }) : s.length || r.report("comments_coral", "auth_response", {
                        status: "excluded"
                    }), a.initStream({
                        token: ""
                    }))
                ...
                initStream: function(t) {
                    ...
                    document.addEventListener("query.CoralEmbedStream_Embed.ready", (function() {
                        document.addEventListener("wp.stream.commentCount", (function(t) {
                            var i = t.detail.totalCommentCount,
                                r = void 0 === i ? 0 : i;
                            e && window.console && console.log && console.log("pb:wp.stream.commentCount", r),
                                function(t, n) {
                        ...
                        events: function(t) {
                            ...
                            t.once("query.CoralEmbedStream_Embed.ready", (function(t) {
                                var n = new CustomEvent("query.CoralEmbedStream_Embed.ready", {
                                    detail: t
                                });
                                ...
                                document.dispatchEvent(new CustomEvent("wp.stream.commentCount", {
                                    detail: {
                                        totalCommentCount: t
                                    }
                                }))
                ...
                rejectAuthResponse: function(t, n, e) {
                    return r.report("comments_coral", "auth_response", {
                        status: "excluded"
                    }), {
                        token: "",
                        error: e
                ...
                authStatusMessages: {
                    ...
                    incomplete: function() {
                        var t = window.TWP.signin.profileUrl,
        ...
        for (var r in t) {
            ...
            "object" != e(i[o]) && (i[o] = {
                _listeners: [],
                _called: !1
            }), "*" == a ? i[o]._listeners.push({
                callback: t[r],
                context: n
            }) : ("object" != e(i[o][a]) && (i[o][a] = {
                _listeners: [],
                _called: !1
            }), i[o][a]._listeners.push({
                callback: t[r],
                context: n
            }))
        }
    ...
    t.exports = function(t) {
        ...
        "use strict";
        var i = e(1).isInBrowser,
            r = new(e(2))(i ? document.body : null);
        ...
        var d = !!h && {
            ...
            p = function() {
                ...
                return t.prototype.listenToDOM = function() {
                    ...
                    if (this.latestEvent = i, this.viewportTop = t, this.viewportHeight = n, this.viewportBottom = t + n, this.contentHeight = e, r)
        ...
        function i(t, n, e) {
            function i(t, n) {
                if (0 !== t.length)
                    for (v = t.length; v--;)(y = t[v]).callback.call(_, n, _), y.isOne && t.splice(v, 1)
            }
        ...
        i.prototype = {
            ...
            off: function(t, n) {
                ...
                for (var e, i = 0; e = this.callbacks[t][i]; i++)
                    if (e.callback === n) {
    ...
    t.exports = {
        init: function(t, n) {
            ...
            return this.wrapper = r.select(t), this.data = n, this.lastDatum = this.data[this.data.length - 1], this.draw = o, this.mousemove = a, this.mouseout = s, this.timeFormat = u, this.numberFormat = function(t) {
                ...
                return "<tspan>".concat(e.numberFormat(t.count), "</tspan><tspan y=18 x=0>cas</tspan>")
            }, this.margin = {
                left: 58,
                right: 50,
                top: 10,
                ...
                return n === i.length - 1 ? "".concat(e.numberFormat(t), " cas aux Etats-Unis") : e.numberFormat(t)
    ...
    function u() {
        ...
        return this.chart = this.wrapper.selectAll(".chart").data(this.data).enter().append("div").attr("class", "chart"), this.chart.append("div").attr("class", "title").text((function(t) {
            return t.name
        })), this.svg = this.chart.append("svg"), this.g = this.svg.append("g"), this.x = i.scaleLinear().domain([0, a]), this.y = i.scaleLinear().domain([0, o]), this.stackGenerator = i.stack().keys(["malade", "well", "recovered"]), this.areaGenerator = i.area().x((function(n) {
        ...
        setUpLVScrollMonitor: function() {
            i(document.getElementsByClassName("looping-video")).forEach((function(t, n) {
                ...
                e.enterViewport((function() {
                    ...
                    if (n) r.loopingVideoLookup[i] = r.createLoopingVideo(t, n, i);
                    else try {
    ...
    /*if (window.muteErrors || -1 != document.location.href.indexOf("template=iframe") || window.TWPHead.ready("main.js", (function() {
            TWP && TWP.Analytics && TWP.Analytics.init && TWP.Analytics.init({
                snowflake: !0,
                trackScrolling: {
                    omniture: !1
                }
            })
        })), (c("video") || $(".powa").length > 0) && p("//www.washingtonpost.com/player/prod/PoWaLoaderWapo.js", "defer"), $(".looping-video").length > 0 && p("//d2p9l91d5g68ru.cloudfront.net/LoopingVideo/LoopingVideo.min.js", "defer", (function() {
            r.init()
        })), !window.muteErrors) {
        var f = window && window.location && window.location.href,
            d = new RegExp("(https?://localhost)|(/graphics/test/)");
        !f.match(d) && (l.coralInitEventMonitors(), l.coratTalkControllerInit())
    }*/

    function p(t, n, e) {
        var i = document.createElement("script"),
            r = "defer" === n ? "defer" : "async";
